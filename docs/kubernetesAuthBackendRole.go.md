...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v7/kubernetesauthbackendrole"
...
| <code><a href="#@cdktf/provider-vault.kubernetesAuthBackendRole.KubernetesAuthBackendRoleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.16.0/docs/resources/kubernetes_auth_backend_role#id KubernetesAuthBackendRole#id}. |
