...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v15/transformalphabet"
...
| <code><a href="#@cdktf/provider-vault.transformAlphabet.TransformAlphabetConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.4.0/docs/resources/transform_alphabet#id TransformAlphabet#id}. |
