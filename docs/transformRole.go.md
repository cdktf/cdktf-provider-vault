...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v10/transformrole"
...
| <code><a href="#@cdktf/provider-vault.transformRole.TransformRoleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.0/docs/resources/transform_role#id TransformRole#id}. |
