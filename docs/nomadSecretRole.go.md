...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v13/nomadsecretrole"
...
| <code><a href="#@cdktf/provider-vault.nomadSecretRole.NomadSecretRoleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.6.0/docs/resources/nomad_secret_role#id NomadSecretRole#id}. |
