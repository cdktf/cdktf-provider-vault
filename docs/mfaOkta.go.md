...
Refer to the Terraform Registory for docs: [`vault_mfa_okta`](https://registry.terraform.io/providers/hashicorp/vault/3.16.0/docs/resources/mfa_okta).
...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v8/mfaokta"
