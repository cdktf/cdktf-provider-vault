...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v14/gcpauthbackend"
...
&gcpauthbackend.GcpAuthBackendConfig {
	...
	ClientId: *string,
	Credentials: *string,
	CustomEndpoint: github.com/cdktf/cdktf-provider-vault-go/vault/v14.gcpAuthBackend.GcpAuthBackendCustomEndpoint,
	Description: *string,
