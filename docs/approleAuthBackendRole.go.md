...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v10/approleauthbackendrole"
...
| <code><a href="#@cdktf/provider-vault.approleAuthBackendRole.ApproleAuthBackendRoleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.1/docs/resources/approle_auth_backend_role#id ApproleAuthBackendRole#id}. |
