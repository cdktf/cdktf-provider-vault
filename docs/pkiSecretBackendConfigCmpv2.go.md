...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v14/pkisecretbackendconfigcmpv2"
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-vault.pkiSecretBackendConfigCmpv2.PkiSecretBackendConfigCmpv2Authenticators.property.cert">Cert</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/pki_secret_backend_config_cmpv2#cert PkiSecretBackendConfigCmpv2#cert}. |
...
&pkisecretbackendconfigcmpv2.PkiSecretBackendConfigCmpv2Config {
	...
	Backend: *string,
	AuditFields: *[]*string,
	Authenticators: github.com/cdktf/cdktf-provider-vault-go/vault/v14.pkiSecretBackendConfigCmpv2.PkiSecretBackendConfigCmpv2Authenticators,
