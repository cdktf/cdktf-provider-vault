...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v10/githubauthbackend"
...
| <code><a href="#@cdktf/provider-vault.githubAuthBackend.GithubAuthBackendConfig.property.tune">Tune</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.1/docs/resources/github_auth_backend#tune GithubAuthBackend#tune}. |
