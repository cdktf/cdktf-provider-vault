...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v10/datavaultgcpauthbackendrole"
...
| <code><a href="#@cdktf/provider-vault.dataVaultGcpAuthBackendRole.DataVaultGcpAuthBackendRoleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.1/docs/data-sources/gcp_auth_backend_role#id DataVaultGcpAuthBackendRole#id}. |
