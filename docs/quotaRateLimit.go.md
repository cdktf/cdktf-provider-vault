...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v8/quotaratelimit"
...
| <code><a href="#@cdktf/provider-vault.quotaRateLimit.QuotaRateLimitConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.16.0/docs/resources/quota_rate_limit#id QuotaRateLimit#id}. |
