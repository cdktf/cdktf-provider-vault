...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v8/egppolicy"
...
| <code><a href="#@cdktf/provider-vault.egpPolicy.EgpPolicyConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.16.0/docs/resources/egp_policy#id EgpPolicy#id}. |
