...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v10/awssecretbackendrole"
...
| <code><a href="#@cdktf/provider-vault.awsSecretBackendRole.AwsSecretBackendRoleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.1/docs/resources/aws_secret_backend_role#id AwsSecretBackendRole#id}. |
