...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v15/awssecretbackendrole"
...
```go
func MfaSerialNumberInput() *string
```
...
| <code><a href="#@cdktf/provider-vault.awsSecretBackendRole.AwsSecretBackendRoleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.5.0/docs/resources/aws_secret_backend_role#id AwsSecretBackendRole#id}. |
