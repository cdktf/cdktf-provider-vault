...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/secretssyncassociation"
...
| <code><a href="#@cdktf/provider-vault.secretsSyncAssociation.SecretsSyncAssociationConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.7.0/docs/resources/secrets_sync_association#id SecretsSyncAssociation#id}. |
