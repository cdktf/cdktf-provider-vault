...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v8/provider"
...
| <code><a href="#@cdktf/provider-vault.provider.VaultProviderAuthLogin.property.parameters">Parameters</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.16.0/docs#parameters VaultProvider#parameters}. |
...
&provider.VaultProviderConfig {
	...
	Alias: *string,
	AuthLogin: github.com/cdktf/cdktf-provider-vault-go/vault/v8.provider.VaultProviderAuthLogin,
	AuthLoginAws: github.com/cdktf/cdktf-provider-vault-go/vault/v8.provider.VaultProviderAuthLoginAws,
	AuthLoginAzure: github.com/cdktf/cdktf-provider-vault-go/vault/v8.provider.VaultProviderAuthLoginAzure,
	AuthLoginCert: github.com/cdktf/cdktf-provider-vault-go/vault/v8.provider.VaultProviderAuthLoginCert,
	AuthLoginGcp: github.com/cdktf/cdktf-provider-vault-go/vault/v8.provider.VaultProviderAuthLoginGcp,
	AuthLoginJwt: github.com/cdktf/cdktf-provider-vault-go/vault/v8.provider.VaultProviderAuthLoginJwt,
	AuthLoginKerberos: github.com/cdktf/cdktf-provider-vault-go/vault/v8.provider.VaultProviderAuthLoginKerberos,
	AuthLoginOci: github.com/cdktf/cdktf-provider-vault-go/vault/v8.provider.VaultProviderAuthLoginOci,
	AuthLoginOidc: github.com/cdktf/cdktf-provider-vault-go/vault/v8.provider.VaultProviderAuthLoginOidc,
	AuthLoginRadius: github.com/cdktf/cdktf-provider-vault-go/vault/v8.provider.VaultProviderAuthLoginRadius,
	AuthLoginUserpass: github.com/cdktf/cdktf-provider-vault-go/vault/v8.provider.VaultProviderAuthLoginUserpass,
	CaCertDir: *string,
	CaCertFile: *string,
	ClientAuth: github.com/cdktf/cdktf-provider-vault-go/vault/v8.provider.VaultProviderClientAuth,
	Headers: interface{},
