...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v10/identityoidcassignment"
...
| <code><a href="#@cdktf/provider-vault.identityOidcAssignment.IdentityOidcAssignmentConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.1/docs/resources/identity_oidc_assignment#id IdentityOidcAssignment#id}. |
