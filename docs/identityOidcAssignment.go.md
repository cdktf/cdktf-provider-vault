...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v7/identityoidcassignment"
...
| <code><a href="#@cdktf/provider-vault.identityOidcAssignment.IdentityOidcAssignmentConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.16.0/docs/resources/identity_oidc_assignment#id IdentityOidcAssignment#id}. |
