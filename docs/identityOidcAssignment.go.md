...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v15/identityoidcassignment"
...
| <code><a href="#@cdktf/provider-vault.identityOidcAssignment.IdentityOidcAssignmentConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.2.1/docs/resources/identity_oidc_assignment#id IdentityOidcAssignment#id}. |
