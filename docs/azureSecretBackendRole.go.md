...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v15/azuresecretbackendrole"
...
| <code><a href="#@cdktf/provider-vault.azureSecretBackendRole.AzureSecretBackendRole.property.persistAppInput">PersistAppInput</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-vault.azureSecretBackendRole.AzureSecretBackendRole.property.persistApp">PersistApp</a></code> | <code>interface{}</code> | *No description.* |
...
```go
func PersistAppInput() interface{}
```
...
| <code><a href="#@cdktf/provider-vault.azureSecretBackendRole.AzureSecretBackendRoleConfig.property.persistApp">PersistApp</a></code> | <code>interface{}</code> | If true, persists the created service principal and application for the lifetime of the role. |
