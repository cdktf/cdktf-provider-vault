...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v10/pkisecretbackendkey"
...
| <code><a href="#@cdktf/provider-vault.pkiSecretBackendKey.PkiSecretBackendKeyConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.19.0/docs/resources/pki_secret_backend_key#id PkiSecretBackendKey#id}. |
