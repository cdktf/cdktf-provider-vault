...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v15/pkisecretbackendsign"
...
| <code><a href="#@cdktf/provider-vault.pkiSecretBackendSign.PkiSecretBackendSignConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/pki_secret_backend_sign#id PkiSecretBackendSign#id}. |
