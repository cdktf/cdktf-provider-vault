...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v14/adsecretlibrary"
...
| <code><a href="#@cdktf/provider-vault.adSecretLibrary.AdSecretLibraryConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/ad_secret_library#id AdSecretLibrary#id}. |
