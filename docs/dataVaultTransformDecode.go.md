...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v7/datavaulttransformdecode"
...
| <code><a href="#@cdktf/provider-vault.dataVaultTransformDecode.DataVaultTransformDecodeConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.15.2/docs/data-sources/transform_decode#id DataVaultTransformDecode#id}. |
