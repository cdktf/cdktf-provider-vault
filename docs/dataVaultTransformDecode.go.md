...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v13/datavaulttransformdecode"
...
| <code><a href="#@cdktf/provider-vault.dataVaultTransformDecode.DataVaultTransformDecodeConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/data-sources/transform_decode#id DataVaultTransformDecode#id}. |
