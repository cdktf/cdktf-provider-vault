...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v14/datavaultidentityentity"
...
| <code><a href="#@cdktf/provider-vault.dataVaultIdentityEntity.DataVaultIdentityEntityConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/data-sources/identity_entity#id DataVaultIdentityEntity#id}. |
