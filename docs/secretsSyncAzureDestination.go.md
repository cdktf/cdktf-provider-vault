...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v15/secretssyncazuredestination"
...
| <code><a href="#@cdktf/provider-vault.secretsSyncAzureDestination.SecretsSyncAzureDestinationConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.2.1/docs/resources/secrets_sync_azure_destination#id SecretsSyncAzureDestination#id}. |
