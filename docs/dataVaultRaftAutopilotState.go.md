...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v7/datavaultraftautopilotstate"
...
| <code><a href="#@cdktf/provider-vault.dataVaultRaftAutopilotState.DataVaultRaftAutopilotStateConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.16.0/docs/data-sources/raft_autopilot_state#id DataVaultRaftAutopilotState#id}. |
