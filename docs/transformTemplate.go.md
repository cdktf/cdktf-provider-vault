...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v15/transformtemplate"
...
| <code><a href="#@cdktf/provider-vault.transformTemplate.TransformTemplateConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.0.0/docs/resources/transform_template#id TransformTemplate#id}. |
