...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v15/policy"
...
| <code><a href="#@cdktf/provider-vault.policy.PolicyConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.4.0/docs/resources/policy#id Policy#id}. |
