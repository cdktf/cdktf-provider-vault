...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v9/kvsecretv2"
...
&kvsecretv2.KvSecretV2Config {
	...
	Name: *string,
	Cas: *f64,
	CustomMetadata: github.com/cdktf/cdktf-provider-vault-go/vault/v9.kvSecretV2.KvSecretV2CustomMetadata,
...
| <code><a href="#@cdktf/provider-vault.kvSecretV2.KvSecretV2Config.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.18.0/docs/resources/kv_secret_v2#id KvSecretV2#id}. |
