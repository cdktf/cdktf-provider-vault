...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v14/kvsecretv2"
...
&kvsecretv2.KvSecretV2Config {
	...
	Name: *string,
	Cas: *f64,
	CustomMetadata: github.com/cdktf/cdktf-provider-vault-go/vault/v14.kvSecretV2.KvSecretV2CustomMetadata,
