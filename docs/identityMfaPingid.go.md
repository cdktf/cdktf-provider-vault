...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v15/identitymfapingid"
...
| <code><a href="#@cdktf/provider-vault.identityMfaPingid.IdentityMfaPingidConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/identity_mfa_pingid#id IdentityMfaPingid#id}. |
