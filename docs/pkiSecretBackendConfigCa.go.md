...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v7/pkisecretbackendconfigca"
...
| <code><a href="#@cdktf/provider-vault.pkiSecretBackendConfigCa.PkiSecretBackendConfigCaConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.15.1/docs/resources/pki_secret_backend_config_ca#id PkiSecretBackendConfigCa#id}. |
