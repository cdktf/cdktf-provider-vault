...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v15/kmipsecretscope"
...
| <code><a href="#@cdktf/provider-vault.kmipSecretScope.KmipSecretScopeConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.0.0/docs/resources/kmip_secret_scope#id KmipSecretScope#id}. |
