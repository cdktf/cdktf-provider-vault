...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v10/kmipsecretscope"
...
| <code><a href="#@cdktf/provider-vault.kmipSecretScope.KmipSecretScopeConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.20.1/docs/resources/kmip_secret_scope#id KmipSecretScope#id}. |
