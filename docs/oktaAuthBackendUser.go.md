...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v14/oktaauthbackenduser"
...
| <code><a href="#@cdktf/provider-vault.oktaAuthBackendUser.OktaAuthBackendUserAConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/okta_auth_backend_user#id OktaAuthBackendUserA#id}. |
