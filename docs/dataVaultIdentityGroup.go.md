...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v13/datavaultidentitygroup"
...
| <code><a href="#@cdktf/provider-vault.dataVaultIdentityGroup.DataVaultIdentityGroupConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/data-sources/identity_group#id DataVaultIdentityGroup#id}. |
