...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v9/githubuser"
...
| <code><a href="#@cdktf/provider-vault.githubUser.GithubUserConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.17.0/docs/resources/github_user#id GithubUser#id}. |
