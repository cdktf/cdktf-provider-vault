...
Refer to the Terraform Registory for docs: [`vault_aws_secret_backend_static_role`](https://registry.terraform.io/providers/hashicorp/vault/3.18.0/docs/resources/aws_secret_backend_static_role).
