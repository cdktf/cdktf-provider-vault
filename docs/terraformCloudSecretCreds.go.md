...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v15/terraformcloudsecretcreds"
...
| <code><a href="#@cdktf/provider-vault.terraformCloudSecretCreds.TerraformCloudSecretCredsConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/5.2.1/docs/resources/terraform_cloud_secret_creds#id TerraformCloudSecretCreds#id}. |
