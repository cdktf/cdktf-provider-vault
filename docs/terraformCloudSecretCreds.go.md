...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v7/terraformcloudsecretcreds"
...
| <code><a href="#@cdktf/provider-vault.terraformCloudSecretCreds.TerraformCloudSecretCredsConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.16.0/docs/resources/terraform_cloud_secret_creds#id TerraformCloudSecretCreds#id}. |
