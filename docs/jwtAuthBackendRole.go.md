...
```go
import "github.com/cdktf/cdktf-provider-vault-go/vault/v9/jwtauthbackendrole"
...
| <code><a href="#@cdktf/provider-vault.jwtAuthBackendRole.JwtAuthBackendRoleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/3.18.0/docs/resources/jwt_auth_backend_role#id JwtAuthBackendRole#id}. |
