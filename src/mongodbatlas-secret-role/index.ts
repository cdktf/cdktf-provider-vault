...
export class MongodbatlasSecretRole extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/3.18.0/docs/resources/mongodbatlas_secret_role vault_mongodbatlas_secret_role} Resource
  *
