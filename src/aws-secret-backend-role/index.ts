...
// https://registry.terraform.io/providers/hashicorp/vault/5.5.0/docs/resources/aws_secret_backend_role
...
export class AwsSecretBackendRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsSecretBackendRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.5.0/docs/resources/aws_secret_backend_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      mfa_serial_number: cdktf.stringToTerraform(this._mfaSerialNumber),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      mfa_serial_number: {
        value: cdktf.stringToHclTerraform(this._mfaSerialNumber),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
