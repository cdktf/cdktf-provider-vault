// https://registry.terraform.io/providers/hashicorp/vault/3.22.0/docs/resources/mfa_okta
...
export class MfaOkta extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MfaOkta that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/3.22.0/docs/resources/mfa_okta#import import section} in the documentation of this resource for the id to use
