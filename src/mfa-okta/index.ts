// https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/resources/mfa_okta
...
export interface MfaOktaConfig extends cdktf.TerraformMetaArguments {
  ...
  * Okta API key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/resources/mfa_okta#api_token MfaOkta#api_token}
  */
  readonly apiToken: string;
  /**
  * If set, will be used as the base domain for API requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/resources/mfa_okta#base_url MfaOkta#base_url}
  */
  readonly baseUrl?: string;
  /**
  * ID computed by Vault.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/resources/mfa_okta#id MfaOkta#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/resources/mfa_okta#name MfaOkta#name}
  */
  readonly name: string;
  /**
  * Target namespace. (requires Enterprise)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/resources/mfa_okta#namespace MfaOkta#namespace}
  */
  readonly namespace?: string;
  /**
  * Name of the organization to be used in the Okta API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/resources/mfa_okta#org_name MfaOkta#org_name}
  */
  readonly orgName: string;
  /**
  * If set to true, the username will only match the primary email for the account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/resources/mfa_okta#primary_email MfaOkta#primary_email}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/resources/mfa_okta vault_mfa_okta}
*/
export class MfaOkta extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MfaOkta that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/resources/mfa_okta#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/resources/mfa_okta vault_mfa_okta} Resource
  *
  * @param scope The scope in which to define this construct
