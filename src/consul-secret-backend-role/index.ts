...
export class ConsulSecretBackendRole extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/3.18.0/docs/resources/consul_secret_backend_role vault_consul_secret_backend_role} Resource
  *
