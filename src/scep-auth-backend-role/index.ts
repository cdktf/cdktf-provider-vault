...
// https://registry.terraform.io/providers/hashicorp/vault/5.5.0/docs/resources/scep_auth_backend_role
...
export interface ScepAuthBackendRoleConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class ScepAuthBackendRole extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "vault_scep_auth_backend_role";
  ...
  * @param importToId The construct id used in the generated config for the ScepAuthBackendRole to import
  * @param importFromId The id of the existing ScepAuthBackendRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.5.0/docs/resources/scep_auth_backend_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "vault_scep_auth_backend_role", importId: importFromId, provider });
      }
  ...
  * @param options ScepAuthBackendRoleConfig
  */
  public constructor(scope: Construct, id: string, config: ScepAuthBackendRoleConfig) {
    super(scope, id, {
      terraformResourceType: 'vault_scep_auth_backend_role',
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      challenge: cdktf.stringToTerraform(this._challenge),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      challenge: {
        value: cdktf.stringToHclTerraform(this._challenge),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
