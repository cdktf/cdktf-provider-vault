...
// https://registry.terraform.io/providers/hashicorp/vault/5.4.0/docs/resources/password_policy
...
export class PasswordPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PasswordPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.4.0/docs/resources/password_policy#import import section} in the documentation of this resource for the id to use
