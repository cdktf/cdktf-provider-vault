// https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/config_ui_custom_message
...
export interface ConfigUiCustomMessageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/config_ui_custom_message#authenticated ConfigUiCustomMessage#authenticated}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/config_ui_custom_message#end_time ConfigUiCustomMessage#end_time}
  */
  readonly endTime?: string;
  /**
  * The base64-encoded content of the custom message
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/config_ui_custom_message#message_base64 ConfigUiCustomMessage#message_base64}
  */
  readonly messageBase64: string;
  /**
  * Target namespace. (requires Enterprise)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/config_ui_custom_message#namespace ConfigUiCustomMessage#namespace}
  */
  readonly namespace?: string;
  /**
  * A map containing additional options for the custom message
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/config_ui_custom_message#options ConfigUiCustomMessage#options}
  */
  readonly options?: { [key: string]: string };
  /**
  * The starting time of the active period of the custom message
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/config_ui_custom_message#start_time ConfigUiCustomMessage#start_time}
  */
  readonly startTime: string;
  /**
  * The title of the custom message
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/config_ui_custom_message#title ConfigUiCustomMessage#title}
  */
  readonly title: string;
  /**
  * The display type of custom message. Allowed values are banner and modal
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/config_ui_custom_message#type ConfigUiCustomMessage#type}
  */
  readonly type?: string;
  /**
  * link block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/config_ui_custom_message#link ConfigUiCustomMessage#link}
  */
...
export interface ConfigUiCustomMessageLink {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/config_ui_custom_message#href ConfigUiCustomMessage#href}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/config_ui_custom_message vault_config_ui_custom_message}
*/
export class ConfigUiCustomMessage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigUiCustomMessage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/config_ui_custom_message#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/config_ui_custom_message vault_config_ui_custom_message} Resource
  *
  * @param scope The scope in which to define this construct
