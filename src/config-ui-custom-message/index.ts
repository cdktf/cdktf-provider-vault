...
// https://registry.terraform.io/providers/hashicorp/vault/4.7.0/docs/resources/config_ui_custom_message
...
export class ConfigUiCustomMessage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigUiCustomMessage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/4.7.0/docs/resources/config_ui_custom_message#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/4.7.0/docs/resources/config_ui_custom_message vault_config_ui_custom_message} Resource
  *
  * @param scope The scope in which to define this construct
