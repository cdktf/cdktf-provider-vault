...
// https://registry.terraform.io/providers/hashicorp/vault/3.25.0/docs/resources/token_auth_backend_role
...
export class TokenAuthBackendRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TokenAuthBackendRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/3.25.0/docs/resources/token_auth_backend_role#import import section} in the documentation of this resource for the id to use
