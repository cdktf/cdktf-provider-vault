// https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role
...
export interface TokenAuthBackendRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role#allowed_entity_aliases TokenAuthBackendRole#allowed_entity_aliases}
  */
  readonly allowedEntityAliases?: string[];
  /**
  * List of allowed policies for given role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role#allowed_policies TokenAuthBackendRole#allowed_policies}
  */
  readonly allowedPolicies?: string[];
  /**
  * Set of allowed policies with glob match for given role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role#allowed_policies_glob TokenAuthBackendRole#allowed_policies_glob}
  */
  readonly allowedPoliciesGlob?: string[];
  /**
  * List of disallowed policies for given role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role#disallowed_policies TokenAuthBackendRole#disallowed_policies}
  */
  readonly disallowedPolicies?: string[];
  /**
  * Set of disallowed policies with glob match for given role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role#disallowed_policies_glob TokenAuthBackendRole#disallowed_policies_glob}
  */
  readonly disallowedPoliciesGlob?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role#id TokenAuthBackendRole#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role#namespace TokenAuthBackendRole#namespace}
  */
  readonly namespace?: string;
  /**
  * If true, tokens created against this policy will be orphan tokens.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role#orphan TokenAuthBackendRole#orphan}
  */
  readonly orphan?: boolean | cdktf.IResolvable;
  /**
  * Tokens created against this role will have the given suffix as part of their path in addition to the role name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role#path_suffix TokenAuthBackendRole#path_suffix}
  */
  readonly pathSuffix?: string;
  /**
  * Whether to disable the ability of the token to be renewed past its initial TTL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role#renewable TokenAuthBackendRole#renewable}
  */
  readonly renewable?: boolean | cdktf.IResolvable;
  /**
  * Name of the role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role#role_name TokenAuthBackendRole#role_name}
  */
  readonly roleName: string;
  /**
  * Specifies the blocks of IP addresses which are allowed to use the generated token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role#token_bound_cidrs TokenAuthBackendRole#token_bound_cidrs}
  */
  readonly tokenBoundCidrs?: string[];
  /**
  * Generated Token's Explicit Maximum TTL in seconds
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role#token_explicit_max_ttl TokenAuthBackendRole#token_explicit_max_ttl}
  */
  readonly tokenExplicitMaxTtl?: number;
  /**
  * The maximum lifetime of the generated token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role#token_max_ttl TokenAuthBackendRole#token_max_ttl}
  */
  readonly tokenMaxTtl?: number;
  /**
  * If true, the 'default' policy will not automatically be added to generated tokens
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role#token_no_default_policy TokenAuthBackendRole#token_no_default_policy}
  */
  readonly tokenNoDefaultPolicy?: boolean | cdktf.IResolvable;
  /**
  * The maximum number of times a token may be used, a value of zero means unlimited
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role#token_num_uses TokenAuthBackendRole#token_num_uses}
  */
  readonly tokenNumUses?: number;
  /**
  * Generated Token's Period
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role#token_period TokenAuthBackendRole#token_period}
  */
  readonly tokenPeriod?: number;
  /**
  * Generated Token's Policies
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role#token_policies TokenAuthBackendRole#token_policies}
  */
  readonly tokenPolicies?: string[];
  /**
  * The initial ttl of the token to generate in seconds
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role#token_ttl TokenAuthBackendRole#token_ttl}
  */
  readonly tokenTtl?: number;
  /**
  * The type of token to generate, service or batch
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role#token_type TokenAuthBackendRole#token_type}
  */
  readonly tokenType?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role vault_token_auth_backend_role}
*/
export class TokenAuthBackendRole extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the TokenAuthBackendRole to import
  * @param importFromId The id of the existing TokenAuthBackendRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "vault_token_auth_backend_role", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/4.2.0/docs/resources/token_auth_backend_role vault_token_auth_backend_role} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      allowed_entity_aliases: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._allowedEntityAliases),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      allowed_policies: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._allowedPolicies),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      allowed_policies_glob: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._allowedPoliciesGlob),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      disallowed_policies: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._disallowedPolicies),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      disallowed_policies_glob: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._disallowedPoliciesGlob),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      ...
      orphan: {
        value: cdktf.booleanToHclTerraform(this._orphan),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      path_suffix: {
        value: cdktf.stringToHclTerraform(this._pathSuffix),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
