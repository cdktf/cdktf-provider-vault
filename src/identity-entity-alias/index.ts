...
// https://registry.terraform.io/providers/hashicorp/vault/5.5.0/docs/resources/identity_entity_alias
...
export class IdentityEntityAlias extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityEntityAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.5.0/docs/resources/identity_entity_alias#import import section} in the documentation of this resource for the id to use
