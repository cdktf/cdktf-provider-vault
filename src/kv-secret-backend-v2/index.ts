...
// https://registry.terraform.io/providers/hashicorp/vault/4.5.0/docs/resources/kv_secret_backend_v2
...
export class KvSecretBackendV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KvSecretBackendV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/4.5.0/docs/resources/kv_secret_backend_v2#import import section} in the documentation of this resource for the id to use
