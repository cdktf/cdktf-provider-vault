// https://www.terraform.io/docs/providers/vault/r/gcp_auth_backend_role
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      bound_instance_groups: cdktf.listMapper(cdktf.stringToTerraform)(this._boundInstanceGroups),
      bound_labels: cdktf.listMapper(cdktf.stringToTerraform)(this._boundLabels),
      bound_projects: cdktf.listMapper(cdktf.stringToTerraform)(this._boundProjects),
      bound_regions: cdktf.listMapper(cdktf.stringToTerraform)(this._boundRegions),
      bound_service_accounts: cdktf.listMapper(cdktf.stringToTerraform)(this._boundServiceAccounts),
      bound_zones: cdktf.listMapper(cdktf.stringToTerraform)(this._boundZones),
