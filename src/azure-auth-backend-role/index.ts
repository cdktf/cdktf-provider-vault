// https://registry.terraform.io/providers/hashicorp/vault/3.21.0/docs/resources/azure_auth_backend_role
...
export class AzureAuthBackendRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureAuthBackendRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/3.21.0/docs/resources/azure_auth_backend_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/3.21.0/docs/resources/azure_auth_backend_role vault_azure_auth_backend_role} Resource
  *
  * @param scope The scope in which to define this construct
