// https://www.terraform.io/docs/providers/vault/d/gcp_auth_backend_role
...
*/
export class DataVaultGcpAuthBackendRole extends cdktf.TerraformDataSource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DataVaultGcpAuthBackendRoleConfig) {
    super(scope, id, {
