// https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/data-sources/aws_access_credentials
...
export interface DataVaultAwsAccessCredentialsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/data-sources/aws_access_credentials#backend DataVaultAwsAccessCredentials#backend}
  */
  readonly backend: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/data-sources/aws_access_credentials#id DataVaultAwsAccessCredentials#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/data-sources/aws_access_credentials#namespace DataVaultAwsAccessCredentials#namespace}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/data-sources/aws_access_credentials#role DataVaultAwsAccessCredentials#role}
  */
  readonly role: string;
  /**
  * ARN to use if multiple are available in the role. Required if the role has multiple ARNs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/data-sources/aws_access_credentials#role_arn DataVaultAwsAccessCredentials#role_arn}
  */
  readonly roleArn?: string;
  /**
  * User specified Time-To-Live for the STS token. Uses the Role defined default_sts_ttl when not specified
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/data-sources/aws_access_credentials#ttl DataVaultAwsAccessCredentials#ttl}
  */
  readonly ttl?: string;
  /**
  * Type of credentials to read. Must be either 'creds' for Access Key and Secret Key, or 'sts' for STS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/data-sources/aws_access_credentials#type DataVaultAwsAccessCredentials#type}
  */
...
export class DataVaultAwsAccessCredentials extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVaultAwsAccessCredentials that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/data-sources/aws_access_credentials#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/4.0.0/docs/data-sources/aws_access_credentials vault_aws_access_credentials} Data Source
  *
  * @param scope The scope in which to define this construct
