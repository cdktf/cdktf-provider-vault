...
// https://registry.terraform.io/providers/hashicorp/vault/5.5.0/docs/resources/transit_secret_backend_key
...
export class TransitSecretBackendKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransitSecretBackendKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.5.0/docs/resources/transit_secret_backend_key#import import section} in the documentation of this resource for the id to use
