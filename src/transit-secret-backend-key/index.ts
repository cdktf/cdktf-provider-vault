// https://registry.terraform.io/providers/hashicorp/vault/5.0.0/docs/resources/transit_secret_backend_key
...
export class TransitSecretBackendKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransitSecretBackendKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.0.0/docs/resources/transit_secret_backend_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      hybrid_key_type_ec: cdktf.stringToTerraform(this._hybridKeyTypeEc),
      hybrid_key_type_pqc: cdktf.stringToTerraform(this._hybridKeyTypePqc),
      ...
      parameter_set: cdktf.stringToTerraform(this._parameterSet),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      hybrid_key_type_ec: {
        value: cdktf.stringToHclTerraform(this._hybridKeyTypeEc),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      hybrid_key_type_pqc: {
        value: cdktf.stringToHclTerraform(this._hybridKeyTypePqc),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      parameter_set: {
        value: cdktf.stringToHclTerraform(this._parameterSet),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
