...
// https://registry.terraform.io/providers/hashicorp/vault/5.2.1/docs/resources/okta_auth_backend
...
export class OktaAuthBackend extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OktaAuthBackend that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.2.1/docs/resources/okta_auth_backend#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/5.2.1/docs/resources/okta_auth_backend vault_okta_auth_backend} Resource
  *
  * @param scope The scope in which to define this construct
