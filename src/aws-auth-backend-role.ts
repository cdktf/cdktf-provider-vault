  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      bound_account_ids: cdktf.listMapper(cdktf.stringToTerraform)(this._boundAccountIds),
      bound_ami_ids: cdktf.listMapper(cdktf.stringToTerraform)(this._boundAmiIds),
      bound_ec2_instance_ids: cdktf.listMapper(cdktf.stringToTerraform)(this._boundEc2InstanceIds),
      bound_iam_instance_profile_arns: cdktf.listMapper(cdktf.stringToTerraform)(this._boundIamInstanceProfileArns),
      bound_iam_principal_arns: cdktf.listMapper(cdktf.stringToTerraform)(this._boundIamPrincipalArns),
      bound_iam_role_arns: cdktf.listMapper(cdktf.stringToTerraform)(this._boundIamRoleArns),
      bound_regions: cdktf.listMapper(cdktf.stringToTerraform)(this._boundRegions),
      bound_subnet_ids: cdktf.listMapper(cdktf.stringToTerraform)(this._boundSubnetIds),
      bound_vpc_ids: cdktf.listMapper(cdktf.stringToTerraform)(this._boundVpcIds),
