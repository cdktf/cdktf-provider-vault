...
// https://registry.terraform.io/providers/hashicorp/vault/5.2.1/docs/resources/kmip_secret_scope
...
export class KmipSecretScope extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KmipSecretScope that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.2.1/docs/resources/kmip_secret_scope#import import section} in the documentation of this resource for the id to use
