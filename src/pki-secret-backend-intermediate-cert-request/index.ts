// https://registry.terraform.io/providers/hashicorp/vault/4.1.0/docs/resources/pki_secret_backend_intermediate_cert_request
...
export class PkiSecretBackendIntermediateCertRequest extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PkiSecretBackendIntermediateCertRequest that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/4.1.0/docs/resources/pki_secret_backend_intermediate_cert_request#import import section} in the documentation of this resource for the id to use
