...
// https://registry.terraform.io/providers/hashicorp/vault/4.6.0/docs/resources/token
...
export class Token extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Token that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/4.6.0/docs/resources/token#import import section} in the documentation of this resource for the id to use
