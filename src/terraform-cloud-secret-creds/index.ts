...
// https://registry.terraform.io/providers/hashicorp/vault/5.1.0/docs/resources/terraform_cloud_secret_creds
...
export class TerraformCloudSecretCreds extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TerraformCloudSecretCreds that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.1.0/docs/resources/terraform_cloud_secret_creds#import import section} in the documentation of this resource for the id to use
