...
// https://registry.terraform.io/providers/hashicorp/vault/5.4.0/docs/resources/generic_secret
...
export class GenericSecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GenericSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.4.0/docs/resources/generic_secret#import import section} in the documentation of this resource for the id to use
