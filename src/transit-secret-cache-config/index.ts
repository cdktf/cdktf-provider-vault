...
export class TransitSecretCacheConfig extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/3.18.0/docs/resources/transit_secret_cache_config vault_transit_secret_cache_config} Resource
  *
