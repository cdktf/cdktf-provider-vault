...
// https://registry.terraform.io/providers/hashicorp/vault/5.2.1/docs/resources/approle_auth_backend_role_secret_id
...
export class ApproleAuthBackendRoleSecretId extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApproleAuthBackendRoleSecretId that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.2.1/docs/resources/approle_auth_backend_role_secret_id#import import section} in the documentation of this resource for the id to use
