// https://registry.terraform.io/providers/hashicorp/vault/3.21.0/docs/resources/terraform_cloud_secret_role
...
export class TerraformCloudSecretRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TerraformCloudSecretRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/3.21.0/docs/resources/terraform_cloud_secret_role#import import section} in the documentation of this resource for the id to use
