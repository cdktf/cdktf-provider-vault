// https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/saml_auth_backend_role
...
export class SamlAuthBackendRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SamlAuthBackendRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/saml_auth_backend_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/4.8.0/docs/resources/saml_auth_backend_role vault_saml_auth_backend_role} Resource
  *
  * @param scope The scope in which to define this construct
