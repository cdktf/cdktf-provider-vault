// https://registry.terraform.io/providers/hashicorp/vault/3.25.0/docs/resources/nomad_secret_backend
...
export class NomadSecretBackend extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NomadSecretBackend that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/3.25.0/docs/resources/nomad_secret_backend#import import section} in the documentation of this resource for the id to use
