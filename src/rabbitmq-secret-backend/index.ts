...
export class RabbitmqSecretBackend extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/3.18.0/docs/resources/rabbitmq_secret_backend vault_rabbitmq_secret_backend} Resource
  *
