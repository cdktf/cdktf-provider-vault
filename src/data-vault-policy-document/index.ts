...
// https://registry.terraform.io/providers/hashicorp/vault/5.5.0/docs/data-sources/policy_document
...
export class DataVaultPolicyDocument extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVaultPolicyDocument that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/5.5.0/docs/data-sources/policy_document#import import section} in the documentation of this resource for the id to use
