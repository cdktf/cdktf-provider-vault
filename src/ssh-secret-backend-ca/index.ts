...
export class SshSecretBackendCa extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/vault/3.18.0/docs/resources/ssh_secret_backend_ca vault_ssh_secret_backend_ca} Resource
  *
