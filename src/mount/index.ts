...
// https://registry.terraform.io/providers/hashicorp/vault/4.1.0/docs/resources/mount
...
export class Mount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Mount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/vault/4.1.0/docs/resources/mount#import import section} in the documentation of this resource for the id to use
